...
const cources =[
  'Product Management', 'Strategy & Leadership', 'Business Management', 'Fintech', 'Senior Management', 'Data Science', 'Digital Transformation', 'Business Analytics'
]
const programs=[
  {
  ...
  {
    "Programs": "Executive Program in Product Management and Digital Transformation",
    "Referrer_Bonus": "₹10,000",
    "Referee_Bonus": "₹10,000"
  },
  {
...
function Refer() {
  ...
  return (
    <>
    <div className="mx-auto w-1/2 text-center p-4 rounded-3xl shadow-lg border mt-8 mb-16 " style={{width:'1000px'}}>
        <div className=" flex lg:gap-x-12 item-center" >
            <div className="  items-center" >
                ...
                <div className='font-semibold'>
                    <p className="text-xl my-20 ">Refer your friends and earn upto 20% discount on your next course</p>
                </div>
                <a
                href="#"
            ...
            <img className ="w-120  "src={image1} alt="image1" style={{height:'500px'}} />
        </div>
    </div>
    <div className="flex flex-col items-center justify-center bg-blue-50 py-10">
      <h2 className="text-2xl font-bold mb-10">How Do I <span className="text-blue-600">Refer?</span></h2>
      <div className="relative flex items-center justify-center w-full  mb-10 font-semibold">
        ...
        <div className="absolute flex flex-col items-center text-center" style={{ top: '30%', left: '16%' }}>
          <img src={addFriendIcon} alt="Submit referrals" className="w-16 h-14 mb-2" />
          <div className="text-sm w-2/4">Submit referrals easily via our website's referral section.</div>
        </div>
        <div className="absolute flex flex-col items-center text-center" style={{ top: '30%', left: '37%' }}>
          <img src={rimg2} alt="Earn rewards" className="w-16 h-14 mb-2" />
          <div className="text-sm w-2/4 ">Earn rewards once your referral joins an Accredian program.</div>
        </div>
        <div className="absolute flex flex-col items-center text-center" style={{ top: '30%', left: '59%' }}>
          <img src={rimg3} alt="Receive bonus" className="w-16 h-14 mb-2" />
          <div className="text-sm w-2/4">Both parties receive a bonus of 30 days after program enrollment.</div>
        </div>
      </div>
      <button
    ...
    {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700">Referrer Email</label>
                <input
                  type="email"
                  name="referrerEmail"
      ...
      <div className='items-center justify-center'>
        <div className="items-center justify-center flex text-2xl font-bold pt-10 pb-5">What Are{" "}<strong className='text-blue-600'> The Referral Benefits?</strong> </div>
              ...
              <table className=" w-72 rounded border-gray-300 ">
                <thead>
                  <tr className="w-full bg-blue-500  leading-6 ">
                    <th className="py-3 px-6 text-left text-white">All Programs</th>
                  </tr>
                </thead>
                <tbody className=" text-sm ">
                  {cources.map((course) => (
                  <tr className="  border-gray-200 hover:bg-gray-100 ">
                    <td className="py-3 px-6 text-left flex font-normal flex-row uppercase"><strong>{course}</strong>
            ...
            <table className="min-w-full border-gray-300 ">
              <thead>
                <tr className="w-full bg-blue-300  leading-6 ">
                  ...
                  <th className="py-3 px-6 text-center text-blue-900">Referrer Amount 2</th>
                  <th className="py-3 px-6 text-center text-blue-900">Referee Amount</th>
                </tr>
              </thead>
              <tbody className=" text-sm ">
                ...
                <tr className="  border-gray-200 hover:bg-gray-100 ">
                  ...
                  <td className="py-3 px-6 text-center">{program.Referrer_Bonus}</td>
                  <td className="py-3 px-6 text-center">{program.Referee_Bonus}</td>
